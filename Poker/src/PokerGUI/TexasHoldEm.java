 ...
 */
public class TexasHoldEm extends GameOfPoker {
    
    /**
     * An object from the CheckHand2 Class.
     */
    private CheckHand2 b;
    
    /**
     * Auxiliary String type List.
     */
    public ArrayList<String> arrayListNumber, arrayListColour;
    
    /**
     * An array list with all the common cards.
     */
    public ArrayList<String> commonCards;
    
    /**
     * The Class Constructor.
     */
    public TexasHoldEm(int type, ArrayList<Player> pl)
    {
        super(type,pl);
    ...
    /**
     * A method that simulates a Texas Hold'Em game.
     */
    public void Play()
    {
        // Initialize /betSoFar.
        ...
        while (stillPlayingInGame != 1)
        {
            ...
            /*
             * A procedure that deals 2 close cards to the players.
             */
            counter = 51;
            ...
            {
                /*
                 * Procedure in which the dealer deals the 3 common cards.
                 */
                System.out.println("\nThe first 3 common cards:");
                // Each one of the 3 cards...
                for (i=0;i<3;i++)
                {
                    card2 = tempDeck.get(counter);
                    for (j=0;j<p.size();j++)
                    ...
                    // ...add it in the common cards array list...
                ...
                {
                    /*
                     * The dealer deals the 4rd common card to the players.
                     */
                    // Create the 4th card and...
                    card2 = tempDeck.get(counter);
                    System.out.println("\nThe 4th common card is " + card2 + ".");
                    ...
                    // Add the card in the array list with the common cards...
                    commonCards.add(card2);
                    // ...and remove it from the deck.
                    tempDeck.remove(counter);
                    counter--;
                    System.out.println("The 4 common cards:");
                    // Print the common cards.
                    for (i=0;i<commonCards.size();i++)
                    {
                        System.out.println(commonCards.get(i));
                    }
                    ...
                    {
                        /*
                         * The dealer deals the 5th common card to the players.
                         */
                        //Create the 5th card and...
                        card2 = tempDeck.get(counter);
                        System.out.println("\nThe 5th common card is " + card2 + ".");
                        // ...give it to each player...
                        for (j=0;j<p.size();j++)
                        {
                            if (p.get(j).getIsInTurn() == true)
                        ...
                        tempDeck.remove(counter);
                        counter--;
                        System.out.println("The 5 common cards:");
                        // Print the common cards.
                        for (i=0;i<commonCards.size();i++)
                        {
                            System.out.println(commonCards.get(i));
